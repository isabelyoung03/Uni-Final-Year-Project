...
class GhostListFactory:
    ...
    def get_ghost_list(maze, search_algorithm_enum) -> list:
        ...
        if maze_size == MazeSize.SMALL and search_algorithm_enum == SearchAlgoType.REFLEX:
            ghost1 = Ghost(5,4, maze, GhostBehaviour.INTELLIGENT)
            return [ghost1]

        elif maze_size == MazeSize.MEDIUM and search_algorithm_enum == SearchAlgoType.REFLEX:
            ghost1 = Ghost(10,6, maze, GhostBehaviour.INTELLIGENT)
            ghost2 = Ghost(4,14, maze, GhostBehaviour.INTELLIGENT)
            ghost3 = Ghost(8,8, maze, GhostBehaviour.INTELLIGENT)
            return [ghost1, ghost2, ghost3]
        
        elif maze_size == MazeSize.LARGE and search_algorithm_enum == SearchAlgoType.REFLEX:
            ghost1 = Ghost(5,4, maze, GhostBehaviour.INTELLIGENT)
            ghost2 = Ghost(22,2, maze, GhostBehaviour.INTELLIGENT)
            ghost3 = Ghost(4,14, maze, GhostBehaviour.INTELLIGENT)
            ghost4 = Ghost(8,9, maze, GhostBehaviour.INTELLIGENT)
            ghost5 = Ghost(12,5, maze, GhostBehaviour.INTELLIGENT)
            ghost6 = Ghost(15,3, maze, GhostBehaviour.INTELLIGENT)
            return [ghost1, ghost2, ghost3, ghost4, ghost5, ghost6]
